      ...
      body: Column(
        ...
        children: [
          Padding(
            ...
            child: Text(beer.name!,maxLines: 2,overflow: TextOverflow.ellipsis,style: textStyle(
              Colors.white,
              'Anta-Regular',
              22,
            ),),
                  ...
                  children: [
                    Row(
                      children: [
                        Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [const Text("Vol."), Text("${beer.volume!.value.toString()} ${beer.volume?.unit!}")]),
                        const SizedBox(width: 25,),
                        Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [const Text("Abv."), Text(beer.abv.toString())]),
                      ],
                    ),
                    ...
                    Text(beer.description!,maxLines: 10,overflow: TextOverflow.ellipsis,),
                    const Spacer(),
                    SizedBox(
                      width: MediaQuery.sizeOf(context).width,
                      height: 55,
                      child: roundedElevatedButton('Add to cart', Colors.black, () async {
                      },15),
                    )
                  ],
                ),
